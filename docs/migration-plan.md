...
2. Replace website layout with minimal campaign layout and extracted base styles. Use /, /result, /share/:handle, /improve and /opportunities. Keep assets under /recruiters-view to avoid unnecessary material changes.
